...
class MapDemoViewTests(TestCase):
    def test_demo_page_returns_200(self):
        ...
        self.assertContains(response, "採点する")
        self.assertContains(response, "selected-grid-label")
        self.assertContains(response, "selected-grid-rating-form")
        self.assertContains(response, "selected-grid-score")
        self.assertContains(response, "selected-grid-rate-button")
